...
import { createTableStore, type TableStoreInitialState, type TableStoreState } from './table-store';

/**
 * Global registry for table stores
 * Allows multiple table instances to exist independently
 */
const storeRegistry = new Map<string, StoreApi<TableStoreState>>();
 ...
 */
export function getTableStore(id: string): StoreApi<TableStoreState> | undefined {
 ...
 */
export function getTableState(id: string): TableStoreState | null {
