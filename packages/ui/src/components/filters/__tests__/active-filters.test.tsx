...
describe('ActiveFilters', () => {
  ...
  it('should handle text filter value formatting', () => {
    ...
    render(<ActiveFilters {...defaultProps} filters={[textFilter]} />);
  ...
  it('should handle number filter value formatting', () => {
    ...
    render(<ActiveFilters {...defaultProps} filters={[numberFilter]} />);
  ...
  it('should handle option filter value formatting', () => {
    ...
    render(<ActiveFilters {...defaultProps} filters={[optionFilter]} />);

    expect(screen.getByText('Status: in "active", "inactive"')).toBeInTheDocument();
  });
  ...
  it('should handle empty filters array', () => {
    render(<ActiveFilters {...defaultProps} filters={[]} />);

    expect(screen.queryByRole('button')).not.toBeInTheDocument();
  });

  it('should handle disabled state', () => {
    render(<ActiveFilters {...defaultProps} disabled={true} />);
  ...
  it('should handle protected filters', () => {
    const isFilterProtected = (filter: FilterState) => filter.columnId === 'name';

    render(<ActiveFilters {...defaultProps} isFilterProtected={isFilterProtected} />);
  ...
  it('should apply custom className', () => {
    const { container } = render(<ActiveFilters {...defaultProps} className="custom-class" />);
  ...
  it('should handle filter with null values', () => {
    ...
    render(<ActiveFilters {...defaultProps} filters={[nullFilter]} />);
  ...
  it('should handle filter with multiple values', () => {
    ...
    render(<ActiveFilters {...defaultProps} filters={[multiValueFilter]} />);
  ...
  it('should handle unknown column gracefully', () => {
    ...
    render(<ActiveFilters {...defaultProps} filters={[unknownFilter]} />);
