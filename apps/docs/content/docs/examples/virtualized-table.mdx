...
description: Complete example of a high-performance virtualized table with filtering, sorting, and pagination
---

This example demonstrates a fully integrated virtualized table with filtering, sorting, and pagination for handling large datasets (50k+ rows) with smooth performance.
...
- **Virtual Scrolling**: Handles 250k+ rows with only ~20-30 DOM nodes
- **Real-time Filtering**: Instant filter application with multiple operators
- **Multi-column Sorting**: Sort by multiple columns simultaneously
- **Performance Metrics**: Track filtering and data processing
- **Custom Cell Rendering**: Styled cells based on data values
- **Responsive Design**: Works on mobile, tablet, and desktop

## Performance Benefits

- Only ~20-30 DOM nodes rendered at once
- Smooth 60 FPS scrolling regardless of dataset size
- Instant filtering without UI freezing
...
- [Virtualized Table Component](/docs/ui/tables) - VirtualizedTable component reference
- [Filter Components](/docs/ui/filters) - FilterBar and ActiveFilters components
- [Column Builders Guide](/docs/core/column-builders) - Building type-safe columns
