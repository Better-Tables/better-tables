---
title: Next.js with shadcn/ui Setup
description: Step-by-step guide to integrate Better Tables UI with Next.js and shadcn/ui
---
...
- Explore the [component documentation](/docs/ui/components)
- See [custom UI examples](/docs/ui/custom-integration) for using your own components
- Check out the [core documentation](/docs/core/user-guide) for advanced features
