---
title: Architecture
description: Understanding the Better Tables architecture and design decisions
---
...
├── apps/
│   ├── marketing/      # Public site with live interactive demo (@better-tables/site)
│   └── docs/           # Fumadocs documentation site (@better-tables/docs)
├── docs/               # Package-level API reference (markdown)
