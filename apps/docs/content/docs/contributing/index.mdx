---
title: Contributing
description: Guide for contributing to Better Tables
---
...
│       └── rest/
├── apps/
│   ├── marketing/            # Public site with live demo (@better-tables/site)
│   └── docs/                 # Fumadocs docs site (@better-tables/docs)
├── docs/                     # Package-level API reference
