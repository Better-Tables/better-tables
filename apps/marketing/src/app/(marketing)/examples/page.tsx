...
export const metadata = constructMetadata({
  title: 'Examples',
  description:
    'Seven live Better Tables examples across backends: homepage users on Postgres (Neon) or SQLite fallback, plus ticket demos on in-memory SQLite — relationship filtering, query groups, virtualization, facets, CSV export, and a metadata-driven admin navigator.',
});
