...
- Apps: `apps/marketing`, `apps/docs`, `apps/marketing` — check each `package.json` for a `typecheck` script before assuming (unverified; the plan handles both cases in Step 3).
