...
| Topic | Docs path |
|---|---|
| Why Better Tables (positioning) | `/docs/why-better-tables` |
| Architecture Overview | `/docs/architecture` |
| Column Definition (Builder API) | `/docs/columns` |
| Auto columns | `/docs/columns/auto-columns` |
| Advanced Filtering System (operator reference) | `/docs/filtering` |
| Sorting | `/docs/sorting` |
| Pagination | `/docs/pagination` |
| Facets | `/docs/facets` |
| Selection & bulk actions | `/docs/selection-and-actions` |
| Inline editing | `/docs/inline-editing` |
| Large datasets / virtualization | `/docs/large-datasets` |
...
| Custom adapters (toolkit) | `/docs/adapters/custom` |
